...
HD_PWD='D:/WorkSpace/AC/laborator_7_MG/laborator_7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log main_project.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source main_project.tcl -notrace
