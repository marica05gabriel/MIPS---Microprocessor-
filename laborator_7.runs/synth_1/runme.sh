...
HD_PWD='D:/WorkSpace/AC/laborator_7_MG/laborator_7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_project.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_project.tcl
